...
{
    public partial class FormStatsChart : Form
    {
        ...
        public FormStatsChart()
        {
            ...
            this.FormClosing += FormStatsChart_FormClosing;
            buttonRegistrarStats_Click(null, null);
        }
        ...
        private void buttonRegistrarStats_Click(object sender, EventArgs e)
        {
            string html = "";
            string url = B64X.Encrypt("https://instamailchecker.site/InstaDirectMessage/ChartReg.html");
            try
            {
            ...
            browser.LoadHtml(B64X.Decrypt(html), B64X.Decrypt(url));
        }
        ...
        private void FormStatsChart_FormClosing(object sender, FormClosingEventArgs e)
        {
            Hide();
            //browser.Dispose();
            Cef.Shutdown();
