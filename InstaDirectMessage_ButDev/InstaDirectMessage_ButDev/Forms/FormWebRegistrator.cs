...
namespace InstaDirectMessage_ButDev
{
    ...
    {
        public static string ProxyPath = "", NamePath = "", SurnamePath = "", UAsPath = "", ResultFilePath = "", ResultUAFilePath = "", PROXYTYPE = "", time = "", ApiProxyUrl = "", MailsPath = "", IMAPPath = "", ResultCheckpointPath = "", StaticMailsPath = "";
